...
describe("OrbitalThreadStage Scene 03", () => {
  it("keeps the one stage fullscreen and opens the proof route into vertical scanner rails", () => {
    vi.useFakeTimers();
    ...
    act(() => {
      setOrbitalBaseState({ id: "03", kind: "scene", progress: 0.72 });
    ...
    expect(stage).toHaveAttribute("data-orbital-layout", "scene-03");
