...
describe("OrbitalThreadStage Scene 02", () => {
  it("keeps the persistent stage fullscreen and opens its paths into the proof route", () => {
    vi.useFakeTimers();
    ...
    act(() => {
      setOrbitalBaseState({ id: "02", kind: "scene", progress: 0.72 });
    ...
    expect(stage).toHaveAttribute("data-orbital-layout", "scene-02");
